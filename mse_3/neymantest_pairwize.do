...
clear all
set more off
import delimited "http://www.evens-salies.com/electric.company.short.csv", ///
				delimiters(";")
...
* Estimateur de la variance (pairwise)
...
* IC (dependent samples)
display			"Two-population mean"
